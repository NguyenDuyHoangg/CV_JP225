...
<head>
  ...
  <title>JP225_Nguyen Duy Hoang</title>
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="/home/"><i class="bi bi-house-fill fs-5"></i></a></li>
          ...
          <li class="dropdown"><a href="/home/tin-tuc/" class="fs-5"><span>Tin tức</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="/home/s" class="fs-5">Tìm kiếm</a></li>
              <li><a href="#" class="fs-5">Drop Down 1</a></li>
              <li><a href="#" class="fs-5">Drop Down 2</a></li>
              <li><a href="#" class="fs-5">Drop Down 3</a></li>
              <li><a href="#" class="fs-5">Drop Down 4</a></li>
            </ul>
          </li>
