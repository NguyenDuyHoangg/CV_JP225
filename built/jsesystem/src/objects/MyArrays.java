...
public class MyArrays {
	...
	public static Person[] generatePerson(int n) {
		...
		String[] firstNames = {
			"Duy","Hoàng","Nguyên","Tú","Kiên","Hoa","Huyền","Hải",
			"Lâm","Đức","Thế","Thành","Hà Bảo","Nam","Hà Cường","Diệu",
			"Yến","Ly","Quỳnh","Mai","Dương","Hà","Thúy","Tiến"
		};
		
		String[] lastNames = {
			"Nguyễn","Bùi","Ma","Lê","Tống","Trần","Đào","Đinh",
			"Hoàng","Tô","Đỗ","Vũ","Võ","Phạm","Phùng","Trương",
			"An","Cấn","Phan","Mai","Dương","Hà","Hồ","Đoàn"		
		};
	...
	public static int[] filterPrime(int[] arrInt, boolean isINC) {
		...
		int[] temp1 = new int[arrInt.length];//Mảng nguyên tố
		int[] temp2 = new int[arrInt.length];//Mảng không nguyên tố
		int t1=0, t2=0;
	...
	public static Person[] searchPerson(Person[] list, String name) {	//=> Nâng cấp tập hợp rồi dùng JDK8 để duyệt, in, xử lí
		Person[] results = null;
